...
const ExpenseForm = () => {
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			console.error(
				"Error submitting expnense form",
			...
			<div>
				...
				<div className="relative group">
					...
					>
						...
						<option className="bg-[#101622]" value="Food">
							Food
						</option>

						<option className="bg-[#101622]" value="Shopping">
							Shopping
						</option>

						<option className="bg-[#101622]">Transportation</option>

						<option className="bg-[#101622]" value="Housing">
							Housing
						</option>

						<option className="bg-[#101622]" value="Utilities">
							Utilities
						</option>

						<option className="bg-[#101622]" value="Entertainment">
							Entertainment
						</option>

						<option className="bg-[#101622]" value="Healthcare">
							Healthcare
						</option>
